import { mergeStreams } from "ai/core/util/merge-streams";
import { prepareResponseHeaders } from "ai/core/util/prepare-response-headers";
import {
  AIStreamCallbacksAndOptions,
  createCallbacksTransformer,
} from "ai/streams/ai-stream";
import {
  createStreamDataTransformer,
  StreamData,
} from "ai/streams/stream-data";
